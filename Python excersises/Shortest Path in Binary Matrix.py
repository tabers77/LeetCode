# Algorithms used: Breath first search
...
def shortestPathBinaryMatrix(grid):
    # if there is no lear path we return -1
    if grid[0][0] or grid[-1][-1]:
        return -1

    # we define de deque
    # here we define the coordinates, the x y and current coordinate
    queue = deque([(0, 0, 1)])
...
grid = [[0, 1], [1, 0]]  # [[0, 0, 0], [1, 1, 0], [1, 1, 0]]
